...
public class loginuser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication23/1.png"))); // NOI18N
        jLabel7.setText("jLabel7");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication23/6.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
        jLabel9.setText("MEDICENTER");
        ...
        jTextField2.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createTitledBorder(""), null));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pp=jTextField2.getText();
         System.out.println(db.database("select uname,passwords from users where uname='"+uu+"'","s"));
        if(((db.database("select uname,passwords from users where uname='"+uu+"'","c")).equals("success"))&&((db.database("select uname,passwords from users where uname='"+uu+"'","s")).equals(pp)))
            {
            ...
            jLabel10.setText("INVALID USERNAME OR PASSWORD");
        }
